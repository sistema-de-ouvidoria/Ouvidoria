...
<div class="container mt-4">
    <form id="form" enctype="multipart/form-data" class="row" action="?section=NoticiaControle&function=alterarNoticia" method="post">
        ...
        <div class="form-group col-6">
            <img id="img" name="img" src="arquivos/<?=$noticia->nome_imagem?>" height="100" width="120">
        </div>
        <div class="form-group col-12">
            <label for="subtitulo">Subtítulo:</label>
            <input id="subtitulo" value="<?=$noticia->subtitulo?>" maxlength="250" name="subtitulo" class="form-control" required>
        </div>
        <div class="form-group col-12">
